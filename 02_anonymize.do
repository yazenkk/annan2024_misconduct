...
foreach dta in `private_1' `private_2' {
	...
	else if "`dta'" == "Treatments_4gps_9dist.dta" 		local anon_list localityName districtName regionDistrictCode localityCode geo_dist regionDistrictCode_j localityCode_j
...
qui anonymize, anon_list(districtName ln vn vendor_id vDescribe *Phone* loccode loccodex)
