...
use "$dta_loc/data-Mgt/Exported Raw Data - Live/CusData/CM1.dta", clear
forval k =2/8 {
	merge 1:1 distcode loccode custcode using "$dta_loc/data-Mgt/Exported Raw Data - Live/CusData/CM`k'.dta"
	drop _merge
	}
...
use "$dta_loc/data-Mgt/Exported Raw Data - Live/Merchant/M1.dta", clear
forval k =2/6 {
	merge 1:1 distcode loccode vendor using "$dta_loc/data-Mgt/Exported Raw Data - Live/Merchant/M`k'.dta"
	drop _merge
	}
/*
**SammY: admin data
