...
[separate cleaning from analysis after initial commit]
[Confirm: do we need the regressions + lasso work after Higgins]

*/

use "$dta_loc_repl/01_intermediate/repMkt_w_xtics", clear // YK
